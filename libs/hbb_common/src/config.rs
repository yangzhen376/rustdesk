...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "shzj32210998@300".to_string());
        RwLock::new(map)
    };
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.isqhj.cyou"];
pub const PUBLIC_RS_PUB_KEY: &str = "K7Wy36L2Sovlnphmky7AeCXv5qgEIiaDwOOSxk+wEnQ=";
